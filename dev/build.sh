...
mkdir -p -v citros/live-build-buster/config/includes.chroot/home/edible/ > /dev/null
...
mkdir -p -v citros/live-build-buster/config/includes.chroot/home/edible/wallpapers/ > /dev/null   
cp assets/CitrOS-default.png citros/live-build-buster/config/includes.chroot/home/edible/wallpapers/ > /dev/null
mkdir -p -v citros/live-build-buster/config/includes.chroot/usr/share/lxqt/themes/debian/ > /dev/null   
cp assets/CitrOS-default.png citros/live-build-buster/config/includes.chroot/usr/share/lxqt/themes/debian/

echo "Setting nameserver..."
mkdir -p -v citros/live-build-buster/config/includes.chroot/etc/ > /dev/null
...
mkdir -p -v citros/live-build-buster/config/includes.chroot/lib/live/config/ > /dev/null
...
echo PRETTY_NAME='"CitrOS GNU/Linux"' > citros/live-build-buster/config/includes.chroot/etc/os-release
echo NAME='"CitrOS Debian GNU/Linux"' >> citros/live-build-buster/config/includes.chroot/etc/os-release
echo VERSION_ID='"10"' >>citros/live-build-buster/config/includes.chroot/etc/os-release
echo VERSION='"10 (buster)"' >> citros/live-build-buster/config/includes.chroot/etc/os-release
echo VERSION_CODENAME=buster >> citros/live-build-buster/config/includes.chroot/etc/os-release
echo ID=debian >> citros/live-build-buster/config/includes.chroot/etc/os-release
echo HOME_URL='""' >>citros/live-build-buster/config/includes.chroot/etc/os-release
echo SUPPORT_URL='""' >> citros/live-build-buster/config/includes.chroot/etc/os-release
echo BUG_REPORT_URL='""' >> citros/live-build-buster/config/includes.chroot/etc/os-release
echo "$osrelease" > citros/live-build-buster/config/includes.chroot/etc/os-release
echo "$buildt" > citros/live-build-buster/config/includes.chroot/etc/CitrOSBuild
